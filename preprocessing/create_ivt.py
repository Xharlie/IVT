...
def create_ivt(num_sample, res, expand_rate, cats, raw_dirs, lst_dir, ish5= True, normalize=True, version=1, skip_all_exist=False):
...
if __name__ == "__main__":
    ...
    create_ivt(32768, 256, cats, raw_dirs,
               lst_dir, 0.003, 16384, ish5=True, normalize=True, version=1, skip_all_exist=True)
